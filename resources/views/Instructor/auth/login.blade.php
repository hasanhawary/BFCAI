                ...
                <div class="row flex-row  bg-white">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto">
                            ...
                            <form method="POST" action="{{ route('instructor.login') }}">
                                ...
                                <div class="row" style="margin-bottom:30px" >
                                    ...
                                    <div class="col text-right">
                                        <a class="btn-link"  style="color:#333" href="{{ route('instructor.password.forgot') }}">
                            ...
                            <div class="register">
                                <p>Still do not have an account ? <a  class="btn-link" style="color:#0a8cd7 !important" href="{{route('instructor.register')}}">Create a new account</a></p>
                            </div>
                        </div>
                    </div>
